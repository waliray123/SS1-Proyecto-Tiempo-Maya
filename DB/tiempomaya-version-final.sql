...
-- Tiempo de generación: 13-10-2021 a las 21:07:30
...
INSERT INTO `acontecimiento` (`id`, `titulo`, `autor`, `Periodo_nombre`, `htmlCodigo`, `fechaInicio`, `fechaFin`, `ACInicio`, `ACFin`, `categoria`, `descripcion`) VALUES
(1, 'Escritura', 'admin', 'Clasico', 'sdfasdf', '700', '', 'A.C', ' ', 'Escritura1', NULL);
...
--
-- Volcado de datos para la tabla `categoriacalendario`
--

INSERT INTO `categoriacalendario` (`id_cat_calendario`, `nombre`) VALUES
(1, 'Calendario Cholqij'),
(2, 'Calendario Haab'),
(3, 'Rueda Calendarica'),
(4, 'Cuenta Larga');
...
INSERT INTO `informacion` (`id_informacion`, `nombre_informacion`, `id_cat_calendario`, `descripcion_web`, `descripcion_escritorio`) VALUES
(1, 'Calendario Haab', 2, NULL, 'Calendario Haab\'\r\nEl calendario solar maya, llamado Haab\', es una cuenta de 365 días y por lo tanto se aproxima al año solar.\r\nLa palabra “Haab\'” significa “año” en el idioma maya yucateco. El Haab\' está compuesto por 18 meses de 20\r\ndías cada uno, más un mes que consta de 5 días. Cada mes de 20 días, conocido como uinal, tiene su propio\r\nnombre. Todos estos 18 meses juntos suman 360 días. El último mes, compuesto de 5 días, se conoce como\r\nWayeb. Los 19 meses en su totalidad suman 365 días. '),
(2, 'El Calendario de Cuenta Larga', 4, NULL, 'El Calendario de Cuenta Larga\r\nLos antiguos mayas también usaban un sistema de calendario llamado Cuenta Larga. El calendario de Cuenta Larga da a cada día una denominación única dentro de un período de tiempo de aproximadamente 5125\r\ny 1/3 de años solares o tropicales. Una fecha de Cuenta Larga, más una fecha de la Rueda Calendárica, que\r\nincluye el Tzolk’in y el Haab\', fue utilizada por los antiguos mayas para colocar eventos míticos e históricos\r\nen orden cronológico. El calendario de Cuenta Larga es un sistema que cuenta 5 ciclos de tiempo. Esto es\r\nbastante similar al sistema de calendario gregoriano que cuenta días, años, siglos y milenios. El sistema maya\r\ntambién hace esto, pero la única diferencia consiste en el nombre y la magnitud de los ciclos.'),
(3, 'La Rueda Calendárica', 3, NULL, 'La Rueda Calendárica\r\nEl nombre completo de cualquier fecha en el sistema de calendario maya consiste de una fecha Tzolk’in y\r\nuna fecha Haab\'. La Rueda Calendárica es el entretejido de los calendarios Tzolk’in y Haab\'. En la Rueda\r\nCalendárica, una combinación del Tzolk’in y el Haab no se repetirán hasta que hayan pasado 52 períodos\r\nde 365 días. Esto está basado en el concepto matemático de “el mínimo común denominador” y “el mínimo\r\ncomún múltiplo”. Ambos números, 260 y 365, son divisibles por 5, y 260 dividido por 5 es igual a 52, mientras que 365 dividido por 5 es igual a 73. Por lo tanto, el mínimo común múltiplo de 260 y 365 es 5 x 52 x 73 =\r\n18.980. De este modo, la Rueda Calendárica es igual a 18.980 días, 52 x 365 o 52 años Haab\'. Los mayas creen\r\nque cuando una persona alcanza los 52 años de edad, ellos atienen la sabiduría especial de un anciano. Una\r\nfecha de la Rueda Calendárica, con componentes tanto del calendario Tzolk’in como el Haab\', puede marcar\r\nde forma única un evento dentro de un período de 52 años. Sin embrago, cualquier evento que abarque más\r\nde 52 años requiere un calendario adicional, el calendario de Cuenta Larga. '),
(4, 'El Calendario Tzolk’in', 1, NULL, 'El Calendario Tzolk’in\r\nEl calendario sagrado maya se llama Tzolk’in\r\nen maya yucateco y Chol Q’ij en quiché. Este\r\ncalendario combina 20 días con 13 números,\r\nque cuando se multiplican, suman 260 días.\r\nLa duración del Tzolk’in, 260 días, concuerda\r\ncon los nueve ciclos de la Luna y el período\r\ngestacional de los humanos. El Tzolk’in también está relacionado al paso cenital del Sol y\r\nel ciclo de crecimiento del maíz. '),
(5, 'Calendario lunar', 1, NULL, '	Calendario lunar\r\nAl Cholq’ij también se le denomina calendario lunar y marca nueve lunas llenas, período en el que se gesta un ser humano (García, Curruchiche & Taquirá, 2009, p. 35). De acuerdo con la cosmovisión maya, la lectura de los signos y numerales mayas descritos en este calendario espiritual y material le permite al ajq’ij orientar la vida de las personas, según su fecha de nacimiento; y también es utilizado por la Iyom para programar el recibimiento de una nueva criatura (García, Curruchiche & Taquirá, 2009, p. 47).'),
(6, 'Forma de contar el Cholq’ij', 1, NULL, '	Forma de contar el Cholq’ij\r\nUna manera de contar el Cholq’ij para los maya k’iche’ de la actualidad es iniciar el conteo en Waqxaqib’ B’atz’ (8 B’atz’), repitiendo así cada 260 días ese número y fecha (Aj Xol Ch’ok, 2008). Cada día del calendario se combina con un numeral que va del 1 al 13, hasta completar 260 días. El mismo día en que inicia la cuenta vuelve a repetirse cada 260 días. En la antigüedad se acostumbraba a empezar el calendario en 1 Imox y se seguía el mismo proceso de multiplicación de los numerales con los días para alcanzar el total de 260 (Aj Xol Ch’ok, 2008). \r\nLa construcción del ciclo de 260 días del calendario Cholq’ij tiene como base la disciplina vigesimal maya (13X20); “esta relación organiza una frecuencia matemática del movimiento natural lunar de 13:20 que se determina en base a las gravitaciones, principalmente de la Luna–Tierra, las cualidades del ser en la madre Tierra de acuerdo a su día de engendración, día del nacimiento y su proyección o misión en la vida” (García, Curruchiche & Taquirá, 2009, p. 234). Los días de este calendario “son representados también en los 10 dedos superiores de las manos, más los 10 dedos inferiores de los pies, lo que suma 20, que representa los días del Cholq’ij”, pues la construcción matemática del sistema vigesimal maya “se fundamenta en el Jun Winaq de 20 dedos” (García, Curruchiche & Taquirá, 2009, p. 47 y 234).'),
(7, 'Días del Cholq’ij', 1, NULL, 'En maya k’iche’, los veinte días del Cholq’ij reciben los siguientes nombres: B’atz’, E, Aj, I’x, Tz’ikin, Ajmaq, No’j, Tijax, Kawoq, Ajpu, Imox, Iq’, Aq’ab’al, K’at, Kan, Kame, Kej, Q’anil, Toj, Tz’i’. \r\nEstos nombres corresponden al de los 20 nahuales o signos de los días del calendario, los cuales simbolizan ciertas particularidades que se asocian a las personas según la fecha de su nacimiento (Barrios, 2004; León, 1999; Aj Xol Ch’ok, 2008; Rupflin, 1999).'),
(8, 'Kin', 2, '', 'Kin\r\nEl Kin es el equivalente a los días del mes, pero en lugar de 30 o 31 días, se necesitan 20 para formar un uinal (mes maya). Cada uno cuenta con su representación en jeroglífico junto con su nombre individual que no es el nombre de un número regular.\r\n'),
(9, 'Uinal', 2, NULL, 'Uinal\r\nEl uinal se puede ver como el equivalente a nuestros meses ya que constan de 20 días, pero en lugar de 12 de ellos, el calendario Haab Maya cuenta con 18 de ellos. Los uinales, a parte de contar el tiempo se utilizaban para realizar ciertas actividades.');
...
(2, 'Energia', 'Calendario Cholquij', 'Elementos', NULL),
(0, 'Informacion', 'Calendario Cholquij', 'Informacion', NULL),
...
(0, 'Informacion', 'Rueda Calendarica', 'Informacion', NULL),
(1, 'Kin', 'Calendario Haab', 'Elementos', '<p>aasdfasdf</p>    <figure class=\"easyimage easyimage-full\"><img alt=\"\" src=\"imgs/Kin/0.jpeg\" width=\"300\" />  <figcaption></figcaption>  </figure>    <p> </p>'),
(1, 'Nahual', 'Calendario Cholquij', 'Elementos', NULL),
...
--
ALTER TABLE `categoriacalendario`
  MODIFY `id_cat_calendario` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT de la tabla `informacion`
--
ALTER TABLE `informacion`
  MODIFY `id_informacion` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
